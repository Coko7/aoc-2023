namespace aoc_2023.src.day109
{
    public class Day10Part2Solver : AocSolver
    {
        ...
        public override void Solve()
        {
            ...
            for (int i = 0; i < map.Length; i++)
            {
                ...
                {
                    var pipe = map[i][j];
                    if (pipe == null) Console.Write('.');
                    else if (pipe.Type == 'S') Console.Write('S');
                    else if (pipe.DistanceFromOrigin != null)
                    {
                        char formatted = pipe.Type switch
                        {
                            '7' => '╗',
                            'L' => '╚',
                            'F' => '╔',
            ...
            // NOTE: THIS CODE ALONE DOES NOT GIVE THE SOLUTION!!!
            // Check Day10Part2Solution.md to understand how I managed to find the result for this problem.
        }
