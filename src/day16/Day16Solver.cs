...
{
    public class Day16Solver : AocSolver
    {
        ...
        public override void Solve()
        {
            ...
            grid[0][0].CurrentPassingBeams.Add(Direction.Right);
            ...
            var energy = CountEnergy(grid);
            Console.WriteLine($"Result for part {Part} is {energy}");
        }
